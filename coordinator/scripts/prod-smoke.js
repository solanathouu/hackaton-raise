// Smoke prod strict — reset + S1/S2 + TTS + health. (node scripts/prod-smoke.js)
// Cible : PROD_URL (défaut = déploiement Vultr). Vérifie le vrai stack Crusoe+Gradium en ligne.
